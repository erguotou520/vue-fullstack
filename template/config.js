...
var development = {
  frontend: {
    ...
    assetsPublicPath: '/',
    proxyTable: {
      '/api': { target: 'http://localhost:' + {{#if_eq mock 'backend'}}backendBase.port{{/if_eq}}{{#if_eq mock 'mock'}}{{mockPort}}{{/if_eq}}, changeOrigin: true{{#if_eq mock 'backend'}} {{/if_eq}}{{#if_eq mock 'mock'}}, pathRewrite: { '^/api/': '' }{{/if_eq}}},
